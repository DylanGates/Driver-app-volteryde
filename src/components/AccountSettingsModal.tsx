      ...
      <div className="relative z-10 w-full max-w-2xl rounded-2xl bg-background shadow-2xl max-h-[90vh] overflow-hidden animate-in zoom-in-95 fade-in duration-200">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-80px)]">
          ...
          <div className="bg-gray-50 px-6 py-5">
            <div className="flex gap-2 bg-white rounded-full p-1 shadow-sm border border-gray-200">
              {tabs.map((tab) => (
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id)}
                  className={`flex items-center gap-2 px-5 py-2.5 text-sm font-medium rounded-full transition-all flex-1 justify-center ${
                    activeTab === tab.id
            ...
            {activeTab === "personal" && (
              <div className="space-y-6">
                ...
                <div className="flex flex-col items-center pb-2">
                  ...
                  <h3 className="font-semibold text-gray-900 text-base">Profile Photo</h3>
                  <p className="text-sm text-gray-500">Uploaded on October 25,2025</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        className="w-full pl-10 pr-4 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-secondary border-0 text-gray-900"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-900">Emergency Contact</label>
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              ...
              <div className="space-y-6">
                ...
                <div className="border-2 border-brand-secondary rounded-lg p-4 bg-gray-50">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-foreground mb-1">Electric Bus Information</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary border-0"
                      value="GV-4523-22"
                      readOnly
                    />
                  </div>
                  ...
                  >
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-foreground/60 mt-0.5">{notif.description}</p>
                      </div>
                    </div>
                    <button
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary border-0"
                      value="••••••••••••"
                      readOnly
                    />
                    <button
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="password"
                      className="w-full pl-10 pr-4 py-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary border-0"
          ...
          <div className="flex gap-4 px-6 pb-6 justify-end">
            <button
              onClick={onClose}
              className="px-8 py-3 text-base font-medium border-2 border-gray-300 text-gray-900 rounded-full hover:bg-gray-50 transition-colors"
            >
              Cancel
            </button>
            <button className="px-8 py-3 text-base font-medium bg-brand-secondary text-white rounded-full hover:bg-brand-secondary/90 transition-all shadow-sm hover:shadow flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
